...
namespace DemoFluentAPI.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CategoryId")] Product product)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Category, "Id", "Name", product.CategoryId);
            return View(product);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["Id"] = new SelectList(_context.Category, "Id", "Id", product.Id);
            return View(product);
        }
